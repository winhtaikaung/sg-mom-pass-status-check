MSG_INITIAL_GREETING = "မင်္ဂလာပါ မြန်မာလို Pass အခြေအနေ စစ်ဆေးပေးမယ့်ကိုရွှေ မှ ကြိုဆို ပါတယ်အောက်မှာပြထားတဲ့ ခလုပ်လေးတွေကိုနှိပ်ပြီးစစ်လို့ရပါတယ်"
...
MSG_INVALID_PP_NO = "ပတ်စ်ပို့ နံပတ်ရိုက်တာမှားနေပါတယ် ပြန်စစ်ကြည့်ပါအုန်း"

MSG_WELL_PRESS_BELOW = "ကဲဟုတ်ပါပြီ အောက်ကခလုပ်လေးတွေကို နှိပ်ပြီးမေးလို့ရပြီ"

MSG_ABOUT_US = "ကျွန်တော်တို့ ကတော့ ဒီစင်ကာပူမှာ အလုပ်လုပ်နေကြတဲ့ ဆော့ဝဲ ရေးသားသူများပါ။ ဒီ Messenger Bot Application " \
...
MSG_PRIVACY_POLICY = "ဤMessenger Application သည် MOM ၏ တရားဝင် Application မဟုတ်ပါ\n" \
...
MSG_LICENSE = "ဤMessenger Source Code ကို လည်း အများပြည်သူကြည့်ရှုနိုင်ရန်အလို့ငှာ Github တွင်တင်ထားပါသည်\n" \
...
MSG_RECORD_NOT_FOUND = "ယခုပတ်စပို့နံပတ်နဲ့ သက်ဆိုင်တဲ့ အချက်အလက်ကိုရှာမတွေ့ပါ။\n" \
                       "သေချာအောင် https://eponline.mom.gov.sg/epol/PEPOLENQM008SubmitAction.do မှာစစ်ကြည့်ပါအုန်း"

MSG_RECORD_EXISTS = "အမည်။  ။ {} \n" \
...
MSG_SERVICE_UNAVAILABLE = "PASS စစ်ဆေးခြင်း ဝန်ဆောင်မှု မရနိုင်တော့ပါ\n" \
                          "စစ်ဆေးနိုင်မည့်အချိန်တွေကတော့\nတနင်္လာနေ့ မှ သောကြာနေ့ တွင် နံနက် ၈ : ၀၀ - ည ၈ : ၀၀ အထိ : \nစနေနေ့တွင် နံနက် ၈ : ၀၀ - ညနေ ၂ : ၀၀ အတွင်းသာ\nစစ်လို့ရပါတယ်"

MSG_INTERNAL_SERVER_ERROR = "တောင်းပန်ပါတယ် ရှာဖွေနေစဉ် စနစ်မှာ မှားယွင်းမှုတခုဖြစ်သွားလို့ အစကပြန်စပေးပါ။\n" \
                            "ကျေးဇူးတင်ပါတယ်"
